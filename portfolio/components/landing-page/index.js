...
const LandingPage = () => {
  return (
    <section
      className="h-[100vh] flex items-center justify-center from-gray-900 via-gray-800 to-gray-900 text-gray-900 inset-0 w-full bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] [background-size:16px_16px]"
      id="about-me"
    >
      <div className="text-center max-w-3xl">
        ...
        <div className="flex justify-center gap-8 mb-6">
          <motion.div className="border border-solid p-3 rounded-full bg-gray-800 hover:bg-white  hover:border-blue-500 text-white hover:text-blue-500">
            <Link
              href="https://www.linkedin.com/in/anesurirwa"
              target="_blank"
              className="text-3xl"
            >
              <FaLinkedin />
          ...
          <motion.div className="border border-solid p-3 rounded-full bg-gray-800 text-white hover:bg-white  hover:border-blue-500 hover:text-blue-500">
            <Link
              href="https://www.kaggle.com/anesurirwa"
              target="_blank"
              className="text-3xl"
            >
              <FaKaggle />
          ...
          <div className="border border-solid p-3 rounded-full bg-gray-800 hover:bg-white  hover:border-[#24292e] text-white hover:text-[#24292e]">
            <Link
              href="https://www.github.com/anesu-rirwa"
              target="_blank"
              className="text-3xl"
            >
              <FaGithub />
        ...
        >
          <Link
            className="px-6 py-2 bg-yellow-500 text-gray-800 font-semibold rounded-lg hover:bg-gray-800 hover:text-white"
            href={"#contact-me"}
          >
            Contact Me
          </Link>
          ...
          <Link
            className="px-6 py-2  text-white bg-gray-800 font-semibold rounded-lg hover:bg-yellow-500 hover:text-gray-800"
            href={"#projects"}
          >
            View Projects
          </Link>
      ...
      <motion.div
        className="absolute bottom-10 left-1/2 transform -translate-x-1/2 text-gray-800 hover:text-gray-800 cursor-pointer md:hidden"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
